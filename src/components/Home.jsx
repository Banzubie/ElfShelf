...
function Home () {
  return (
    <div>
      <p>The Elf Shelf<span class="sup">&reg;</span> Holiday Shop is a temporary, in-school gift shop program designed for Elementary and Middle School PTA/PTO/Parent groups that want to bring a free, fun and educational service project to their school.</p>
